...
<body class="bg-gray-100">
        ...
        <div class="flex justify-between">
            <div class="flex items-center">
                <button
                    ...
                    type="button">
                    <svg class="fill-current w-5 text-gray-600" viewBox="0 -21 384 384">
                ...
                <button data-search class="p-4 md:hidden focus:outline-none" type="button">
                    <svg data-search-icon class="fill-current w-4 text-gray-600" viewBox="0 0 512 512" style="top: 0.7rem; left: 1rem;">
                ...
                <div data-search-form class="relative mr-3 hidden md:inline-block">
                    <div class="text-gray-500">
                        <svg data-search-icon class="absolute fill-current w-4 text-gray-600" viewBox="0 0 512 512" style="top: 0.7rem; left: 1rem;">
                            <path d="M225.474 0C101.151 0 0 101.151 0 225.474c0 124.33 101.151 225.474 225.474 225.474 124.33 0 225.474-101.144 225.474-225.474C450.948 101.151 349.804 0 225.474 0zm0 409.323c-101.373 0-183.848-82.475-183.848-183.848S124.101 41.626 225.474 41.626s183.848 82.475 183.848 183.848-82.475 183.849-183.848 183.849z" />
                            <path d="M505.902 476.472L386.574 357.144c-8.131-8.131-21.299-8.131-29.43 0-8.131 8.124-8.131 21.306 0 29.43l119.328 119.328A20.74 20.74 0 00491.187 512a20.754 20.754 0 0014.715-6.098c8.131-8.124 8.131-21.306 0-29.43z" />
                        </svg>
                    </div>
                    <input type="text" placeholder="Search" name="search" id="search" class="h-auto pl-10 py-2 bg-gray-200 text-sm border border-gray-400 rounded-full focus:outline-none focus:bg-white">
                </div>
            </div>

            <div class="flex items-center">
                <button data-messages class="p-3 mr-2 focus:outline-none hover:bg-gray-200 hover:rounded-md" type="button">
                    <svg class="fill-current w-5 text-gray-600" viewBox="0 0 512 512">
                ...
                <button data-notifications class="p-3 mr-3 focus:outline-none hover:bg-gray-200 hover:rounded-md" type="button">
                    <svg class="fill-current w-5 text-gray-600" viewBox="-21 0 512 512">
                ...
                <button data-dropdown class="flex items-center px-3 py-2 focus:outline-none hover:bg-gray-200 hover:rounded-md" type="button" x-data="{ open: false }" @click="open = true" :class="{ 'bg-gray-200 rounded-md': open }">
                    ...
                    <span class="ml-4 text-sm hidden md:inline-block text-gray-600">Cairocoders</span>
                    <svg class="fill-current w-3 ml-4 text-gray-600" viewBox="0 0 407.437 407.437">
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-64 h-screen overflow-y-auto bg-gray-900 border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
            <div class="sidebar text-center bg-purple-800"> <!-- Buradaki bg-gray-900 yerine bg-purple-800 koydum -->
                ...
                <a href="{{ route('admin/home') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        ...
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Message</span>
                    </div>
                </a>
